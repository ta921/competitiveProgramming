...
int main () {
    ...
    for (int i=0; i<q; i++){
        ...
        if(moveToLeft(n,cullent[whichHand],cullent[(whichHand+1)%2]) > moveToLeft(n,cullent[whichHand],t[i])){
            ...
            tmpLeftMoveHandPos[whichHand]=(tmpLeftMoveHandPos[whichHand]-moveToLeft(n,cullent[whichHand],t[i])+n)%n;
        ...
        if(moveToRight(n,cullent[whichHand],cullent[(whichHand+1)%2]) > moveToRight(n,cullent[whichHand],t[i])){
            ...
            tmpRightMoveHandPos[whichHand]=(tmpRightMoveHandPos[whichHand]+moveToRight(n,cullent[whichHand],t[i])+n)%n;
